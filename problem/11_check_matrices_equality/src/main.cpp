...
int main()
{
    Display::displayWelcomeMessage("Welcome to check matrices equality");
    ...
    (CheckMatrix::isMatricesEqual(matrix1, matrix2))
        ? std::cout << "\nThe matrices are equal." << std::endl
        : std::cout << "\nThe matrices are not equal." << std::endl;
